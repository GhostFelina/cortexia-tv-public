...
cd /d "%~dp0"
echo.
echo   [1/4] Kaynak listeler indiriliyor...
...
call :free turkey tr
echo   [2/4] Aday listeler birlestiriliyor...
...
echo   [3/4] Tum yayinlar test ediliyor (20-40 dk)...
...
echo   [4/5] Katalog + altyazi taramasi...
node build-catalog.mjs
node probe-cc.mjs
echo   [5/5] Yayin akisi (EPG) indiriliyor...
node build-epg.mjs
echo.
